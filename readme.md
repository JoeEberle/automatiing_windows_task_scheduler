![Image image_filename](solution_sign.png)# Automating Windows Task Scheduler  - This solution automates creating python script to run in windows task scheduler.![Image image_filename](code.png)
